...
import { ItemListContext } from "../core/itemList/context/item-list-context";
  ...
  render() {
    ...
    function addNew() {
      ...
      modalRef.current.open({
        header: "Create item",
        content: <Form cancel={closeModal} save={onSave} />,
    ...
    return (
      <div>
        ...
        <UU5.Bricks.Modal ref={newModalRef} />
        ...
        <ItemListContext.Provider value={itemList}>
          <ItemList deleteItem={deleteItem} show={show} modal={newModalRef} />
        </ItemListContext.Provider>

        {itemList.length >= show ? (
          <UU5.Bricks.Button borderRadius="12px" content="Show more" onClick={showMore} colorSchema="blue" />
        ) : null}
      </div>
    );
  },
